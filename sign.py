...
def sign(m):
	#generate public key
	#Your code here
	private_key = fastecdsa.ecdsa.keys.get_private_key(curve = curve.secp256k1)
	public_key = fastecdsa.ecdsa.keys.get_public_key(private_key, curve = curve.secp256k1)
	r = 0
	s = 0
